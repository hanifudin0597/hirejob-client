        ...
        {message ? (
          message.map((items, index) => (
            <div key={index} className="row flex">
              ...
              <div className="col-2" style={{ borderRadius: '5px', minHeight: '50vh', backgroundColor: 'white', marginTop: '40px', marginRight: '40px' }}>
              ...
              <div className="col-7" style={{ borderRadius: '5px', minHeight: '50vh', backgroundColor: 'white', marginTop: '40px' }}>
          ...
          <div className="row flex">
            ...
            <div className="col-2" style={{ borderRadius: '5px', minHeight: '50vh', backgroundColor: 'white', marginTop: '40px', marginRight: '40px' }}>
              <div style={{ position: 'relative' }}>
                {/* <Image src={user} width={50} height={50} layout="fixed" style={{ borderRadius: '30px' }} /> */}
                <label style={{ marginTop: '20px', position: 'absolute' }} htmlFor=""><></></label>
              </div>
            </div>
            <div className="col-7" style={{ borderRadius: '5px', minHeight: '50vh', backgroundColor: 'white', marginTop: '40px' }}>
              <div style={{ marginTop: '20px' }}>
